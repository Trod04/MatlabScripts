function [validCT, CT] = MPCOpenCriteriaFile(MeterDir, fidLog)
...
try
    ...
    if fidCF > -1
        ...
        %make 3 CT with info, path dependend CT & detection
        CT.INFO = rawCriteria(1,2:end);
        CT.PATH = cell2mat(rawCriteria(2:end-1,2:end));
        CT.DETECTION = cell2mat(rawCriteria(end,2:end));
